...
import { Card, CardContent } from './ui/card'
import { Badge } from "@/components/ui/badge"
// import { useSelector } from 'react-redux'  // Not used here
// import { Avatar } from './ui/avatar'
// import { AvatarImage } from '@radix-ui/react-avatar'
import { FaRegCalendarAlt } from "react-icons/fa"
// import usericon from '@/assets/images/user.png'
        ...
        <Link to={RouteBlogDetails(props.category.slug, props.slug)}>
            ...
            <Card className="pt-5 h-full flex flex-col justify-between">
                ...
                <CardContent>
                    <div className='flex items-center justify-between'>
                        <div className='flex justify-between items-center gap-2'>
                            {/* Avatar and author name can go here */}
                        </div>
                    ...
                    <div className='my-2'>
                        ...
                        <img src={props.featuredImage} className='rounded h-48 w-full object-contain bg-white' />
