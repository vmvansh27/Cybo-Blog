...
const Comment = ({ props }) => {
    ...
    return (
        <div>
            <h4 className='flex items-center gap-2 text-2xl font-bold'> <FaComments className='text-blue-500' /> Comment</h4>

            <h4 className='flex items-center gap-2 text-2xl font-bold'> <FaComments style={{color: "#3594d5"}} /> Comment</h4>
